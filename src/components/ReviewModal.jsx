...
export default function ReviewModal({ review, isOpen, onClose, currentUserId, onToggleLike }) {
  // We can't render if we don't have document.body (e.g. SSR)
            ...
            <div className="p-6 sm:p-8 overflow-y-auto">
              ...
              <div className="pt-6 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Heart className={`w-5 h-5 ${review.likes.includes(currentUserId) ? 'fill-current' : ''}`} />
                    {review.likes.includes(currentUserId) ? 'Liked' : 'Like Review'}
                  </button>
